        ...
        <section id="skills" className="py-24 relative bg-slate-900/50">
            <div className="container mx-auto px-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 auto-rows-[150px]">
                    ...
                    <div className="col-span-2 row-span-2 glass rounded-2xl p-8 flex flex-col justify-end group hover:border-[var(--color-electric-violet)]/50 transition-colors relative overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-br from-[var(--color-electric-violet)]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                    ...
                    {skills.map((skill, index) => (
                        <div key={index} className="glass rounded-2xl p-6 flex flex-col items-center justify-center gap-3 hover:scale-[1.02] hover:bg-white/10 transition-all cursor-default">
                            ...
                            <span className="px-3 py-1 rounded-full bg-slate-800 text-xs font-medium text-[var(--color-neon-cyan)] border border-[var(--color-neon-cyan)]/20">
                                {skill.category}
                            </span>
                        </div>
                    ))}
                    ...
                    <div className="col-span-2 glass rounded-2xl p-8 flex flex-col justify-center group hover:border-[var(--color-emerald-400)]/50 transition-colors relative overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-br from-[var(--color-emerald-400)]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
